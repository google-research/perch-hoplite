...
class CallDensityPlattScaling(CallDensityEstimator):
  ...
  def estimate_deployment_call_density(  # pyrefly: ignore[bad-override]
      ...
      apply_occupancy_gate: bool = True,
  ) -> dict[str, tuple[float, np.ndarray]]:
    """Estimates call density per deployment.
    ...
    Args:
      ...
      apply_occupancy_gate: Whether to apply an occupancy gate to the call
        density estimate at the recording level.
